...
func TestWithIntArray(t *testing.T) {
	expected := []int{0, 2, 4, 6, 8}

	d := WithIntArray(expected)
...
func TestWithFloatArray(t *testing.T) {
	expected := []float32{0, 2.904, 5.808, 8.712, 11.616, 14.52}

	d := WithFloatArray(expected)
...
func TestWithFloatMatrix(t *testing.T) {
	expected := [][]float32{
		{0., 0., 0., 0., 0.},
